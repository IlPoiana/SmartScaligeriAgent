...
export class MultiIntentionRevisionRevise extends IntentionRevisionRevise {
    ...
    /**
     * This loop should handle the multi agent Intentions, custom intentions and plans for the tunnel case
     */
    // async loop(){
    //     while ( true ) {
    //         if(!this.belief_set.idle){
    ...
    //                     this.intention_queue.shift();
    //                     console.log("CHECK loop:", this.current_intention.predicate);
    //                     await intention.achieve().then(
    //                         //res ok-failed-exchange_wait-exchange_bring
    //                         (res) => {
    //                             switch(res){
    //                                 case 'ok':
    ...
    //                                 case 'exchange_wait':
    //                                     int =new Intention(['exchange_wait'])
    //                                     int.achieve()
    //                                 case 'exchange_bring':
    //                                     int =new Intention(['exchange_bring'])
    //                                     int.achieve()
    //                             }
    //                             console.log("achieved intention: ", res)

    //                         }
    //                     ).catch( 
    //                         err => console.log("something went wrong in achieving your intention: ", err)
    //                     );
    //                 }
    //                 else{
    //                     console.log( 'Skipping intention because no more valid', intention.predicate )
    ...
    */
    ...
    /**
     * 
     * call this function when you have a parcel to deliver but can't reach a delivery tile but your friend yes
     */
    // meetRequest(){
    //     const friend = this.#friend_believe_set.team_data;
    //     for(let tile of this.belief_set.delivery_map)
    //         if(BFS([friend.getX(),friend.getY()], [tile.x,tile.y], this.belief_set.original_map) != null){
    //             //send meet request for wait_and_deliver
    //             break
    //         }
    //     return
